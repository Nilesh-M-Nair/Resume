        ...
        <span className='social'>
            <span className='social__container'>
                <span className='social__box1'>
                    <a target='_blank' rel="noopener noreferrer" href='https://www.linkedin.com/in/nilesh-nair-45434315a/'>
                        <img className="social__image-linkedin" src={socialJSON[0].path} alt={socialJSON[0].alt}/>
                    </a>
                </span>
                <span className='social__box2'>
                    <a target='_blank' rel="noopener noreferrer" href='https://github.com/Nilesh-M-Nair'>
